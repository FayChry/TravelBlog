...
<main class="container">
  ...
  <div class="row g-0 p-4 p-md-5 mb-4 rounded" style="background-color:#E5CAC150;">
    <div class="col-lg-6 px-0">
      <h2 class="display-4 fst-italic" style="color:#9A482E;">Σητεία: μια όαση ηρεμίας</h2><br>
      <p class="lead my-3" >Στην ανατολική πλευρά της Κρήτης βρίσκεται αυτό το κρυμμένο διαμάντι. Ένας μέρος που έχει να ανακαλύψεις πολλές ομορφιές της φύσης, μακριά από τα πλήθη που κατακλύζουν οι πιο γνωστοί ελληνικοί προορισμοί.</p>
      <p class="lead mb-0"><a href="sitia.php" class="faylink">Συνεχίστε την ανάγνωση...</a></p>
    </div>
    <div class="col-lg-6 px-0">
      <figure class="polaroidphoto">
        <img src="./assets/images/sitia.jpg" class="img-fluid" width="300px" height="250px" alt="sitia">
        <figcaption>Sitia</figcaption>
      </figure>
    </div>
  </div>
  <!--Card Posts -->
    ...
    <div class="col-md-8">
      <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm position-relative">
          <div class="col p-4 d-flex flex-column position-static">
            <h3 class="mb-0" style="color:#9A482E;">Χριστούγεννα στα Ιωάννινα: όλη η πόλη, μια γιορτή</h3><br>
            <p class="blog-post-meta"><b>Φαίη</b> 02.01.2024</p>
            <p class="card-text mb-auto" style="text-align:justify">Στα Γιάννενα τις παραμονές των Χριστουγέννων και της Πρωτοχρονιάς η πόλη γεμίζει ασφυκτικά από κόσμο, αφού από νωρίς το πρωί όλα τα μαγαζιά εστίασης ξεκινούν να προσφέρουν ψητά και ποτό σε όλους. Στους δρόμους ηχούν παραδοσιακές μουσικές ενώ την τιμητική του έχει το τσίπουρο για τ’ οποίο η πόλη φημίζεται. </p>
            <a href="ioannina.php" class="aplolink icon-link gap-1 icon-link-hover stretched-link">Συνεχίστε την ανάγνωση <svg class="bi"><use xlink:href="#chevron-right"/></svg></a>
          </div>
          <div class="col-auto d-none d-lg-block">
          <img src="./assets/images/ioannina1.jpg" class="img-fluid" style="border-left-style: ridge;" width="300px" height="250px" alt="ioannina">
          </div>
      </div>
      <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm position-relative">
          <div class="col p-4 d-flex flex-column position-static">
            <h3 class="mb-0" style="color:#9A482E;">Μονεμβασιά: η μεσαιωνική Καστροπολιτεία</h3><br>
            <p class="blog-post-meta"><b>Φαίη</b> 05.11.2022</p>
            <p class="card-text mb-auto" style="text-align:justify">Στη Μονεμβασιά, γνωστή και ως Γιβραλτάρ της Ελλάδας, δεν χρειάζεται κανείς χάρτη! Mέσα στα μεσαιωνικά τείχη της Μονεμβασιάς βρίσκεται μια από τις πιο καλοδιατηρημένες και ζωντανές καστροπολιτείες στην Ελλάδα.</p>
            <a href="monemvasia.php" class="aplolink icon-link gap-1 icon-link-hover stretched-link">Συνεχίστε την ανάγνωση <svg class="bi"><use xlink:href="#chevron-right"/></svg></a>
          </div>
          <div class="col-auto d-none d-lg-block">
          <img src="./assets/images/monemvasia1.jpg" class="img-fluid" style="border-left-style: ridge;" width="300px" height="250px" alt="monemvasia">
          </div>
      </div>
      <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm position-relative">
          <div class="col p-4 d-flex flex-column position-static">
            <h3 class="mb-0" style="color:#9A482E;">Σαντορίνη: βόλτες με θέα την καλδέρα</h3><br>
            <p class="blog-post-meta"><b>Φαίη</b> 09.08.2020</p>
            <p class="card-text mb-auto" style="text-align:justify">Το νησί είναι παγκοσμίως διάσημο για την απαράμιλλη φυσική του ομορφιά, το μαγευτικό ηλιοβασίλεμα, το ηφαίστειο με την εντυπωσιακή καλντέρα και τη μοναδική θέα στο Αιγαίο. Ο πολιτισμός της ξεκινάει από τα προϊστορικά χρόνια. Η καλντέρα της είναι από τις πιο επιβλητικές στην Ευρώπη. Έχει κηρυχθεί ως Ιδιαίτερου Φυσικού Κάλλους, όπως και όλη η Θήρα.</p>
            <a href="santorini.php" class="aplolink icon-link gap-1 icon-link-hover stretched-link">Συνεχίστε την ανάγνωση <svg class="bi"><use xlink:href="#chevron-right"/></svg></a>
          </div>
          <div class="col-auto d-none d-lg-block">
          <img src="./assets/images/santorini1.jpg" class="img-fluid" style="border-left-style: ridge;" width="300px" height="250px" alt="santorini">
          </div>
      </div>
      <div class="row g-0 border rounded overflow-hidden flex-md-row mb-4 shadow-sm position-relative">
          <div class="col p-4 d-flex flex-column position-static">
            <h3 class="mb-0" style="color:#9A482E;">Ύδρα: Η Αρχόντισσα του Αργοσαρωνικού</h3><br>
            <p class="blog-post-meta"><b>Φαίη</b> 15.06.2019</p>
            <p class="card-text mb-auto" style="text-align:justify">Η Ύδρα είναι ένας από τους πιο κοσμοπολίτικους προορισμούς της νησιωτικής Ελλάδας. Η μακραίωνη ναυτική παράδοση λάμπει μέχρι σήμερα στα επιβλητικά αρχοντικά Υδραίων καπεταναίων ενώ η ένδοξη συμβολή του νησιού στην Ελληνική Επανάσταση αναβιώνει στα σημαντικά μουσεία του.</p>
            <a href="hydra.php" class="aplolink icon-link gap-1 icon-link-hover stretched-link">Συνεχίστε την ανάγνωση <svg class="bi"><use xlink:href="#chevron-right"/></svg></a>
          </div>
          <div class="col-auto d-none d-lg-block">
          <img src="./assets/images/hydra1.jpg" class="img-fluid" style="border-left-style: ridge;" width="300px" height="250px" alt="Hydra">
          </div>
      </div>
    </div>
    <!--Deksia stili -->
